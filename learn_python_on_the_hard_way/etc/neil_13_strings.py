...
# 引自：http://www.w3cschool.cc/python/python-strings.html
...
以 encoding 指定的编码格式解码 string，如果出错默认报一个ValueError的异常,除非errors指定的是'ignore'或者'replace'
