...
# 引自：Python CGI编程 http://www.w3cschool.cc/python/python-reg-expressions.html
...
Web Client --> HTTP Protocol <-- Web Server <--> Server Side Script <--> Database
"""
...
这个的hello.py脚本是一个简单的Python脚本，
脚本第一的输出内容"Content-type:text/html\r\n\r\n"发送到浏览器并告知浏览器显示的内容类型为"text/html"。
"""
...
这些信息设置在 "Content-type:text/html\r\n\r\n"之前。
